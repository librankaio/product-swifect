                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td hidden><input style='width:120px;' readonly class='noteclass form-control' name='features[]' type='text' value='mcoa'></td>
                                                ...
                                                <tr>
                                                    <td hidden><input style='width:120px;' readonly class='noteclass form-control' name='features[]' type='text' value='mbank'></td>
                                                ...
                                                <tr>
                                                    <td hidden><input style='width:120px;' readonly class='noteclass form-control' name='features[]' type='text' value='mmtuang'></td>
                                                ...
                                                <tr>
                                                    <td hidden><input style='width:120px;' readonly class='noteclass form-control' name='features[]' type='text' value='mcust'></td>
                                                ...
                                                <tr>
                                                    <td hidden><input style='width:120px;' readonly class='noteclass form-control' name='features[]' type='text' value='msupp'></td>
                                                ...
                                                <tr>
                                                    <td hidden><input style='width:120px;' readonly class='noteclass form-control' name='features[]' type='text' value='mlokasi'></td>
                                                ...
                                                <tr>
                                                    <td hidden><input style='width:120px;' readonly class='noteclass form-control' name='features[]' type='text' value='mcabang'></td>
                                                ...
                                                <tr>
                                                    <td hidden><input style='width:120px;' readonly class='noteclass form-control' name='features[]' type='text' value='tpembelianbrg'></td>
                                                ...
                                                <tr>
                                                    <td hidden><input style='width:120px;' readonly class='noteclass form-control' name='features[]' type='text' value='tpos'></td>
                                                ...
                                                <tr>
                                                    <td hidden><input style='width:120px;' readonly class='noteclass form-control' name='features[]' type='text' value='tops'></td>
                                                ...
                                                <tr>
                                                    <td hidden><input style='width:120px;' readonly class='noteclass form-control' name='features[]' type='text' value='tjvouch'></td>
