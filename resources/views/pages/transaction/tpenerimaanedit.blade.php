                                ...
                                <tbody>
                                    @php $counter = 0; @endphp
                                        @for($i = 0; $i < sizeof($tpenerimaands); $i++) @php $counter++; @endphp <tr>
                                            ...
                                            <td><input type='text' style='width:100px;' form='thisform' class='quantityclass form-control' name='quantity[]' value='{{ number_format($tpenerimaands[$i]->qty) }}'></td>
                                            ...
                                            <td><input type='text' readonly form='thisform' style='width:100px;' class='discclass form-control' value='{{ number_format($tpenerimaands[$i]->disc) }}' name='disc_d[]' id='disc_d_{{ $counter }}'></td>
                                            <td><input type='text' readonly form='thisform' style='width:100px;' class='taxclass form-control' value='{{ number_format($tpenerimaands[$i]->tax) }}' name='tax_d[]' id='tax_d_{{ $counter }}'></td>
                                            <td><input type='text' readonly form='thisform' style='width:100px;' class='subtotclass form-control' value='{{ number_format($tpenerimaands[$i]->subtotal, 2, '.', ',') }}' name='subtot_d[]' id='subtot_d_{{ $counter }}'></td>
